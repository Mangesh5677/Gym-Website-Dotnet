            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <asp:HyperLink NavigateUrl="loss.aspx" CssClass="btn btn-success" Text="Plan" runat="server" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <asp:HyperLink NavigateUrl="gain.aspx" CssClass="btn btn-success" Text="Plan" runat="server" />
                        </div>
                    </div>
                </div>
